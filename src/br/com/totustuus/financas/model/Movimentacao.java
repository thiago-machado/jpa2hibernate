...
public class Movimentacao {
	...
	/*
	 * Várias movimentações podem pertencer a uma única conta. 
	 * Ou seja, a cardinalidade é de muitos para um. 
	 * Para indicarmos este tipo de relacionamento no atributo Conta, 
	 * precisaremos utilizar @ManyToOne ("muitas movimentações para uma conta"):
	 */
	@ManyToOne
	private Conta conta;
